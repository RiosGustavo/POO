...
public class Arrays {
    ...
    public static void main(String[] args) {
        ...
        llenadoVector(vectorA, vectorB, n, m);
        mostrarVector(vectorA, vectorB, n, m);
        ordenarVectorA(vectorA, vectorB, n, m);
        iniciarVectorB(vectorB, m);
        insercion(vectorA, vectorB, n, m);
